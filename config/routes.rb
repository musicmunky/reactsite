Rails.application.routes.draw do
	...
	# and will redirect them back to the index page.  It needs to be the last
	# line in the routes file, otherwise...well, EVERYTHING will go to index
	match '*', via: :all, to: 'pages#index'
